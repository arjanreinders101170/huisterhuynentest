...
type Tab = "dashboard" | "boekingen" | "gasten" | "reviews" | "aanvragen" | "producten" | "verblijven" | "tarieven" | "financieel" | "lodge_1" | "lodge_2" | "housekeeping" | "lodge_1_iot" | "lodge_2_iot" | "acties";
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const [bRes, gRes, rRes, aRes, pRes, sRes, dcRes] = await Promise.all([
        ...
        const [bData, gData, rData, aData, pData, sData, dcData] = await Promise.all([bRes.json(), gRes.json(), rRes.json(), aRes.json(), pRes.json(), sRes.json(), dcRes.json()]);
