...
type LandingSection = { eyebrow?: string; heading: string; body: string[]; bullets?: string[] };
type LandingPageRow = {
...
type Tab = "dashboard" | "boekingen" | "gasten" | "reviews" | "aanvragen_v2" | "producten" | "verblijven" | "tarieven" | "financieel" | "lodge_1" | "lodge_2" | "housekeeping" | "lodge_1_iot" | "lodge_2_iot" | "acties" | "blog" | "landingspaginas" | "toeslagen";
...
/* ═══ GASTEN TAB ═══ */
function GastenTab({ guests, stays, bookings, bookingRequests }: { guests: Guest[]; stays: Stay[]; bookings: Booking[]; bookingRequests: BookingRequest[] }) {
  const C = { bg: "#F5F3EE", card: "#fff", border: "#E8E4DC", text: "#2A2418", muted: "#8A7D6A", light: "#B4AFA5", green: "#2F4F3E", gold: "#B49A5E" };
...
function FinancieelTab({ bookings, bookingRequests, stays }: { bookings: Booking[]; bookingRequests: BookingRequest[]; stays: Stay[] }) {
  const C = { bg: "#F5F3EE", card: "#fff", border: "#E8E4DC", text: "#2A2418", muted: "#8A7D6A", light: "#B4AFA5", green: "#2F4F3E", gold: "#B49A5E" };
...
function LandingTab({ pages, setPages }: { pages: LandingPageRow[]; setPages: (p: LandingPageRow[]) => void }) {
  const C = { bg: "#F5F3EE", card: "#fff", border: "#E8E4DC", text: "#2A2418", muted: "#8A7D6A", light: "#B4AFA5", green: "#2F4F3E", gold: "#B49A5E" };
  const [view, setView] = useState<"list" | "edit">("list");
