...
const MONTHS: Month[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "s26-16", title: "Blog: 'Wat kost een privé-lodge met hottub in Nederland?' uitbreiden", category: "Blog", priority: "hoog", keyword: "privé lodge nederland kosten", note: "Staat al op positie 6,4 op een prijszoekopdracht — late funnel, sterkste conversiesignaal van de site. Verdient de sterkste CTA van alle blogs." },
