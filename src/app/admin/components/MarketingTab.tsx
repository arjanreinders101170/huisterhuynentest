...
const MONTHS: Month[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "au11", title: "GBP post plaatsen: 'Heide bloeit! Wij openen 1 apr 2027'", category: "Lokaal", priority: "hoog" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "d26-5", title: "Boekingsflow eindtest vóór de opening", category: "CRO", priority: "kritiek" },
