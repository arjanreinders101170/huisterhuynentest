...
const MONTHS: Month[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "s26-10", title: "Eén term voor het bad in title, H1, intro en FAQ van /vakantiehuis-met-hottub-drenthe", category: "LP", priority: "kritiek", keyword: "huisje met jacuzzi drenthe", note: "Uitgevoerd met 'jacuzzi' (754 vertoningen tegen 249 voor 'hottub'), op 4 september op verzoek teruggedraaid naar 'hottub' als enige term op de hele site. De zoekterm blijft hier staan omdat het is wat mensen intypen. URL ongewijzigd — die 914 vertoningen aan history zijn meer waard dan een keyword in het pad." },
      ...
      { id: "s26-15", title: "noindex op /impressum, /datenschutz, /agb, /privacy, /terms, /welkom", category: "Techniek", priority: "midden", note: "Uitgevoerd op 4 september: de vijf rechtspagina's staan op noindex, follow (/welkom stond al op noindex) en alle zes zijn uit de sitemap gehaald. Bewust géén Disallow in robots.txt: dan zou Google de noindex nooit meer lezen." },
      { id: "s26-16", title: "Blog: 'Wat kost een privé-lodge met hottub in Nederland?' uitbreiden", category: "Blog", priority: "hoog", keyword: "privé lodge nederland kosten", note: "Staat al op positie 6,4 op een prijszoekopdracht — late funnel, sterkste conversiesignaal van de site. Uitgevoerd op 4 september: eigen tarieven, rekenvoorbeeld en FAQ toegevoegd, vanafprijs in de meta description, en als enige blog een CTA naar de beschikbaarheid in plaats van naar de nieuwsbrief. Draai migrations/2026_09_04_blog_prive_lodge_kosten_uitbreiden.sql." },
      { id: "s26-17", title: "Blog: 'Wellnessweekend in Drenthe — hoe ziet zo'n weekend eruit?'", category: "Blog", priority: "hoog", keyword: "wellness weekend drenthe", note: "Uitgevoerd op 4 september: /blog/wellnessweekend-drenthe, met een CTA naar /wellness-vakantie-drenthe. Bewust een andere vraag dan die landingspagina ('wellness huisje'), zodat de twee elkaar niet beconcurreren. Draai migrations/2026_09_04_blog_wellnessweekend.sql." },
      ...
      { id: "s26-19", title: "'wellness huis drenthe' over de rand van de top 20 duwen", category: "LP", priority: "hoog", keyword: "wellness huis drenthe", note: "82 vertoningen, 7,8 posities gestegen en net buiten de top 20 — de enige term in de wellnesscluster die beweegt. De pagina praatte overal over een 'huisje'; het losse woord stond alleen in een bijzin. Uitgevoerd op 5 september: 'wellness huis' in de feitenstrip (nieuw), hero, intro, twee sectiekoppen, twee FAQ-vragen, CTA en meta description, plus een vergelijkingstabel wellness huis / wellnesshotel / dagspa. 'Huisje' blijft in H1, title en breadcrumb: dat is met 128 vertoningen de grotere term. Drie ankerteksten om, waaronder de contextlink op /hunebedden-drenthe. Draai migrations/2026_09_05_wellness_huis_duwtje.sql." },
    ],
  },
  {
    id: "okt-2026",
    ...
    tasks: [
      ...
      { id: "o26-4",  title: "Blogs: inline CTA halverwege + sticky CTA toevoegen", category: "CRO", priority: "hoog", note: "Blogs halen CTR 3,31% tegen 0,25% voor de commerciële pagina's. Ze zijn het best presterende kanaal en linken nu nauwelijks door. Uitgevoerd op 4 september: halverwege elk artikel staat nu een smalle CTA op de dichtstbijzijnde kopgrens (niet bij artikelen onder de acht blokken — dan staan twee CTA's binnen één schermlengte), en de sticky balk op mobiel volgt de eigen CTA van het artikel in plaats van naar een generiek formulier te wijzen." },
      { id: "o26-5",  title: "/lodge-de-heide bouwen", category: "LP", priority: "kritiek", keyword: "huisje met sauna en jacuzzi drenthe", note: "Er is nu geen enkele stap waarin de bezoeker een lodge kiest — terwijl kiezen precies de stap is die twijfel omzet in commitment. Onderscheid: sauna en panoramisch uitzicht. Uitgevoerd op 4 september: zes H2's volgens het plan, met de sauna als onderscheid en een CTA die De Heide al voorselecteert in de boekingsflow. In de teksten staat 'hottub' en niet 'jacuzzi', omdat dat sinds 4 september het enige woord voor het bad op de hele site is. Draai migrations/2026_09_04_lodgepaginas.sql." },
      { id: "o26-6",  title: "/lodge-de-eik bouwen", category: "LP", priority: "kritiek", keyword: "vakantiehuisje jacuzzi zeijen", note: "Écht anders schrijven dan De Heide: buitenkeuken en BBQ zijn hier het onderscheid. Twee bijna identieke lodgepagina's zijn precies het kannibalisatieprobleem dat de site al heeft. Uitgevoerd op 4 september: eigen H2 over de buitenkeuken en de BBQ, een sectie over Zeijen voor de lokale zoekterm, en geen enkele alinea gedeeld met De Heide. Draai migrations/2026_09_04_lodgepaginas.sql." },
      { id: "o26-7",  title: "Lodgekeuzeblok na de FAQ op de drie P0-landingspagina's", category: "CRO", priority: "hoog", note: "Uitgevoerd op 4 september: staat tussen de FAQ en de slot-CTA — eerst bezwaren wegnemen, dan kiezen, dan datums vragen. Elke kaart heeft twee uitgangen: de lodgepagina voor wie twijfelt, en de beschikbaarheid met die lodge al voorgeselecteerd voor wie eruit is. Op de lodgepagina's zelf toont hetzelfde blok alleen de ándere lodge." },
      { id: "o26-8",  title: "Boekingsflow: lodge voorselecteren via parameter", category: "CRO", priority: "hoog" },
      { id: "o26-9",  title: "Blog: 'Hottub in de winter — waarom december de mooiste maand is'", category: "Blog", priority: "hoog", keyword: "hottub winter" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "n26-9",  title: "Blog: 'Sauna of hottub — wat kiest u?'", category: "Blog", priority: "hoog", keyword: "huisje met sauna en jacuzzi drenthe" },
