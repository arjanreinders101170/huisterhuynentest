...
const faqItems = [
  {
    ...
    a: "Ja, honden zijn van harte welkom! Vermeld dit wel bij uw reservering, zodat wij hier rekening mee kunnen houden.",
  },
  {
    v: "Hoe laat kan ik inchecken en uitchecken?",
    a: "Inchecken kan vanaf 15:00 uur. Uitchecken is uiterlijk om 11:00 uur. In overleg kan hiervan worden afgeweken.",
  },
  {
  ...
  return (
    <section style={{ background: "#F7F4EF", padding: "80px 40px" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        <div style={{
          fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 11, fontWeight: 600,
          color: "#B8860B", letterSpacing: "2.5px", textTransform: "uppercase" as const,
        ...
        <h2 style={{
          ...
          margin: "0 0 48px", lineHeight: 1.15, fontWeight: 700,
        ...
        <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
          {faqItems.map((item, i) => (
            <div key={i} style={{
              borderTop: i === 0 ? "1px solid #DDD8CF" : "none",
              ...
              >
                <span style={{
                  fontFamily: "Georgia, 'Times New Roman', serif",
                  fontSize: 17, fontWeight: 700, color: "#1A1A1A", lineHeight: 1.3,
                }}>
                  {item.v}
                </span>
                <span style={{
                  fontSize: 22, color: "#B8860B", flexShrink: 0,
              ...
              {open === i && (
                <p style={{
                  ...
                  fontSize: 15, color: "#5C5347", fontWeight: 300,
