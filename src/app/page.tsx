...
function BookingSection() {
  ...
  useEffect(() => {
    const opening = new Date(`${BOOKINGS_OPEN_FROM}T00:00:00`);
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              ...
              { label: "EV Laadstation", desc: "Duurzaam reizen? Er is een laadstation aanwezig bij de lodge. Laad op terwijl u geniet; het laden zelf is niet inbegrepen." },
            ].map((usp, i) => (
            ...
            {[
              {
                ...
                slug: "lodge-de-heide",
                tag: "4 personen",
                desc: "Een luxe lodge op de Drentse heide, ingericht voor vier. Panoramisch uitzicht over heide en bos, en een privé-hottub op het terras.",
                features: ["4 personen", "Privé-hottub", "Panoramisch uitzicht", "Geen buren"],
                img: "/lodge-heide.jpg",
              ...
              <div key={lodge.id} style={{
                ...
                <div style={{ padding: 28 }}>
                  ...
                  <div style={{
                    ...
                    Beschikbaar vanaf 1 april 2027 · Openingsseizoen
                  </div>
                  <a
                    href="#reserveren"
      ...
      <section className="hth-gutter" style={{ background: T.bg, paddingTop: 80, paddingBottom: 80, borderTop: `1px solid ${T.border}` }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <SectionHeader
            ...
            sub="Huis ter Huynen opent op 1 april 2027. Vroegboekers claimen nu al hun voorkeursdatum, vóór de officiële opening."
          />
          <div style={{
            display: "grid",
            gridTemplateColumns: "repeat(auto-fit, minmax(min(190px, 100%), 1fr))",
            ...
            {[
              ...
              {
                periode: "Meivakantie",
                datum: "24 apr – 2 mei 2027",
                badge: "Populair",
                badgeKleur: T.green,
                desc: "Lente in Drenthe, jonge dieren en bloeiende bossen. De eerste vakantieweek na de opening.",
              },
              {
                periode: "Hemelvaart & Pinksteren",
                datum: "6 – 17 mei 2027",
                badge: "Langweekend",
                badgeKleur: T.green,
                desc: "Twee lange weekenden vlak na elkaar, met het voorjaar op zijn mooist.",
              },
              {
          ...
          {googleReviews.length === 0 ? (
            <div style={{ textAlign: "center", maxWidth: 560, margin: "0 auto" }}>
              <p style={{ fontFamily: T.sans, fontSize: 15, color: T.muted, fontWeight: 300, lineHeight: 1.8, marginBottom: 8 }}>
                Huis ter Huynen opent op 1 april 2027. De eerste beoordelingen verschijnen
