...
**Inbegrepen zonder toeslag:** de privé hottub op je eigen terras, 24 uur per dag op 38 °C, de buitensauna bij Lodge De Eik, gratis wifi, parkeren op eigen terrein en het gebruik van de laadpaal voor een elektrische auto. Bij veel accommodaties staat minstens één van deze punten als losse post op de rekening.
