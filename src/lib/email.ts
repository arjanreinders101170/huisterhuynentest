...
export function newsletterWelcomeEmail(opts: NewsletterWelcomeEmailOpts): string {
  return lodgeEmail({
    ...
    title: `Welkom${opts.firstName ? `, ${opts.firstName}` : ""}`,
    intro: "Je staat op de lijst. We laten je als eerste weten zodra de boekingen open gaan voor onze opening op 1 april 2027 &mdash; inclusief eventuele vroegboekvoordelen voor nieuwsbrief-abonnees.",
    blocks: [
